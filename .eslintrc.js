module.exports = {
  ...
  rules: {
    'react/react-in-jsx-scope': 'off', // No es necesario importar React en NextJS
    'react/prop-types': 'off', // TypeScript ya maneja la validación de props
    '@typescript-eslint/explicit-module-boundary-types': 'off',
    '@typescript-eslint/no-unused-vars': ['warn', { argsIgnorePattern: '^_' }],
    'jsx-a11y/anchor-is-valid': 'off', // Next.js usa enlaces que no requieren href
