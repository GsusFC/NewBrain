 ...
 * e implementa directamente los controles de grid
 */
    ...
    <div className="p-4 space-y-6 h-full overflow-y-auto custom-scrollbar">
        ...
        {({ open }) => (
          <div className="disclosure-wrapper">
            <Disclosure.Button className="flex w-full justify-between items-center py-2 text-left">
              <h3 className="text-lg font-semibold tracking-tight">Configuración del Grid</h3>
              <ChevronDown
                className={cn(
      ...
      <Disclosure>
        {({ open }) => (
          <div className="disclosure-wrapper">
            <Disclosure.Button className="flex w-full justify-between items-center py-2 text-left">
              <h3 className="text-lg font-semibold tracking-tight">Ajustes Avanzados</h3>
              <ChevronDown
                className={cn(
                  "h-5 w-5 text-muted-foreground transition-transform",
                  open ? "transform rotate-180" : ""
      ...
      <Disclosure defaultOpen>
        {({ open }) => (
          <div className="disclosure-wrapper">
            <Disclosure.Button className="flex w-full justify-between items-center py-2 text-left">
              <h3 className="text-lg font-semibold tracking-tight">Apariencia de Vectores</h3>
              <ChevronDown
                className={cn(
                  "h-5 w-5 text-muted-foreground transition-transform",
                  open ? "transform rotate-180" : ""
